...
else if($vega_wp_frontpage_cta_dark_parallax == 'Y' && $vega_wp_frontpage_cta_dark_bg_image != '') { $class = 'parallax-bg'; $parallax_str = 'data-parallax="scroll" data-image-src="' . esc_url($vega_wp_frontpage_cta_dark_bg_image) . '"'; $style= ''; }
